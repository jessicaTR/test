...
public class Starter implements SrvControl {
	...
	// config file path
	/////////////////////////////////////////////////////////////////////////////////
	private static final String Config_File = "../cfg/chinadataimportexport.conf"; 
//	private static final String Config_File = "D:\\CE WORK FOLDER\\gitDBOR\\dbor_nda_applications-master\\Agriculture\\cfg\\agriculture.conf"; 
	...
	public static String SERVICE_NAME="chinadataimportexport";
	...
	public void Start(Properties prop)
	{
			...
			String ClassName = prop.getProperty(DataSetName + ".fileprocessor");
			...
			ChinaDataImportExportLoader afp =  new ChinaDataImportExportLoader();
