...
public class CommodityFlowGenerator extends GZIPSDIFileGenerator {
	...
	protected String convertContentItem(
		...
		try {
			...
			// add <CommodityFlowID>
			///////////////////////////////
			Element elCommodityFlowID = doc.createElement("CommodityFlowID");
			elCommodityFlowID.appendChild(doc.createTextNode(String.valueOf(commodity_flow_id)));
			elCF.appendChild(elCommodityFlowID);
