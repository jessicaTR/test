...
public class PlantPlaStatistic extends SDICursorRow {
	...
	public PlantPlaStatistic(long Perm_ID, String statistic_type, String statistic_period_type, Integer statistic_year, Float statistic_value, String statistic_measurement, String statistic_validity_type, String statistic_data_source) {
		super(Perm_ID);
	...
	public static PlantPlaStatistic LoadDataFromRS(ResultSet RS) throws SQLException
	{
		...
		Integer statistic_year=RS.getInt("statistic_year");
		if(RS.wasNull())
		{
			statistic_year=null;
		}
		...
		return new PlantPlaStatistic(Perm_id, statistic_type, statistic_period_type, statistic_year, statistic_value, statistic_measurement, statistic_validity_type, statistic_data_source);
	...
	public Integer getStatistic_year() {
